...
class NotAcceptableException extends http_exception_1.HttpException {
    ...
    constructor(message, error = 'Not Acceptable') {
        super(http_exception_1.HttpException.createBody(message, error, http_status_enum_1.HttpStatus.NOT_ACCEPTABLE), http_status_enum_1.HttpStatus.NOT_ACCEPTABLE);
    }
}
