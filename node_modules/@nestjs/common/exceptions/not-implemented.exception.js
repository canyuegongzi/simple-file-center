...
class NotImplementedException extends http_exception_1.HttpException {
    ...
    constructor(message, error = 'Not Implemented') {
        super(http_exception_1.HttpException.createBody(message, error, http_status_enum_1.HttpStatus.NOT_IMPLEMENTED), http_status_enum_1.HttpStatus.NOT_IMPLEMENTED);
    }
}
